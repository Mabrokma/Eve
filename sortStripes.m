...
%separating stripes as a separate figure
%
%**************************************************************************
...
while true
    ...
    %Border redefinition
        ...
        [newBorder, ~] = ginput(1);%, 'Color', fg, 'FigHandle', particleFig);
...
close('all', 'force')
%Use borders to assign the particles to a new CP structure according to
%each stripe
% *** TODO 
% cpByStripe(nStripes) = cp;
% for s = 1:nStripes
%     
% end
